...
class AddMoreFieldsScoreView extends Migration
{
    /**
     * Run the migrations.
     *
            ...
            CREATE VIEW score_view AS
             SELECT sc.id AS score_id,
                ...
                FROM scores sc
                 ...
                 LEFT JOIN program_graduation_category pgc ON gcs.graduation_category_id = pgc.graduation_category_id
                 LEFT JOIN programs p ON p.id = pgc.program_id
