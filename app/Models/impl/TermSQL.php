 ...
 * @method static \Illuminate\Database\Eloquent\Builder|TermSQL whereLink($value)
 */
class TermSQL extends Model implements Term
{
    use SoftDeletes, HasFactory;

    protected $fillable = ['name', 'start_date', 'end_date', 'status', 'school_id', CodeConstant::EX_ID, 'description', 'lms_id', CodeConstant::UUID, 'term_course_code', 'school_year', 'semester_number','link'];
